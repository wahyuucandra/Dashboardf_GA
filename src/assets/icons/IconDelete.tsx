export default function IconDelete({ width = 28, height = 29, ...props }: Readonly<React.SVGProps<SVGSVGElement>>) {
  return (
    <svg width={width} height={height} viewBox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <rect x="0.5" y="1" width="27" height="27" rx="3.5" stroke="#FF4040" />
