  ...
  return (
    <>
      ...
      <div className="px-3 pt-3 pb-20 bg-white h-screen overflow-y-auto">
        <div className="mb-3 px-3 py-2 flex items-center space-x-3 border rounded">
          <IconSearch className="m-auto" width={20} height={20}></IconSearch>
          <input type="text" placeholder="Cari informasi" className="-mt-1 w-full" />
        </div>
