...
function TimeInputComponent({
  ...
  const handleFetchTimesInDay = () => {
    ...
    const validate = (time: Date) => {
      if (endDate) {
        return time?.getTime() < endDate?.date?.getTime()
      }
...
function ManpowerInputComponent({
  appendClick = () => {},
}: Readonly<{
  closeClick?: any
  appendClick?: any
...
const schema = Yup.object().shape({
  ...
  jumlahManpower: Yup.string().required('Jumlah Manpower wajib diisi'),
})
...
export default function ManPowerSchedulePage() {
  ...
  const { handleSubmit } = useForm<IScheduleManpower>({
  ...
  const handleBindSelectedCapacity = () => {
    return selectedCapacity ? selectedCapacity + ' orang' : 'Masukan Kebutuhan Manpower'
  }
      ...
      <div className="relative">
        <div className="sticky top-0">
          ...
          <Image
            width={100}
            height={100}
            className="object-cover w-full max-h-[188px] rounded-b-md"
        ...
        <div className="px-3 pt-6 h-screen overflow-y-auto">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                <label className="container">
                  ...
                  <input
                    type="radio"
                    checked={gender === 'L'} // Periksa apakah gender adalah 'L'
                    onChange={handleGenderChange} // Panggil fungsi handleGenderChange saat radio button berubah
                    name="gender"
                    value="L" // Nilai untuk jenis kelamin laki-laki
                  />
                ...
                <label className="container">
                  ...
                  <input
                    type="radio"
                    checked={gender === 'P'} // Periksa apakah gender adalah 'P'
                    onChange={handleGenderChange} // Panggil fungsi handleGenderChange saat radio button berubah
                    name="gender"
                    value="P" // Nilai untuk jenis kelamin perempuan
                  />
                  <span className="radio"></span>
                </label>
              </div>
            ...
            {/* Time Input */}
            <div onClick={() => setIsTimeOpen(true)} className="mb-6 w-full">
              <div className="text-[#252525] mb-2">
            ...
            <div className="mb-6">
              ...
              {/* <TextAreaForm
                fieldLabel={{ children: 'Keperluan' }}
                fieldInput={{ rows: 5, cols: 30 }}
                control={control}
                name="description"
                counter={true}
              /> */}
            ...
            <div className="mb-6 relative">
              <div className="text-[#252525] mb-2">
                Kebutuhan Manpower <span className="text-[#E15241] -mt-1">*</span>
              </div>
              <div
