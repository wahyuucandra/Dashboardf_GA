		...
		<div className='relative'>
			...
			<div className='px-3 pt-[200px]'>
				<div className='flex items-center space-x-3 mb-4'>
					...
					<div>
						<div className='text-heading xs semibold-16 text-[#2C598D]'>
							Vehicle
						</div>
						<div className='text-[#809BB5] -mt-1'>
							<span className='text-extra-small regular-12'>
								Pilih request yang Anda butuhkan di lokasi{' '}
							</span>
							<span className='text-extra-small semibold-12'>
								ACC HO
							</span>
						</div>
					</div>
				...
				<div className='grid grid-cols-2 gap-4 text-center'>
					<Link
						href={
							'/booking-asset/vehicle/special-operational/schedule'
						}
					...
					>
						...
						<span className='text-paragraph semibold-14 text-[#2C598D]'>
							Operational Khusus
						</span>
					</Link>
					<Link
						href={
							'/booking-asset/vehicle/office-operational/schedule'
						}
						className='bg-[#2C598D]/[.08] shadow-[0_1px_4px_1px_rgba(0,0,0,0.1)] p-6 flex flex-col space-y-3 rounded-[20px]'
					>
