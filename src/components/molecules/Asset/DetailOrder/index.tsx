  ...
  return (
    <>
      ...
      {/* <div className="relative">
        <AssetBannerImage photos={photos}></AssetBannerImage>
        ...
        <div className="px-6 pt-[290px] h-screen">
          <AssetDescription vehicle={vehicle}></AssetDescription>
          <br />
          <AssetInformation vehicle={vehicle}></AssetInformation>
          <br />
          <AssetTerms vehicle={vehicle}></AssetTerms>
          <br />
      ...
      <AssetBooking acceptTerm={acceptTerm}></AssetBooking> */}
    </>
  )
}
