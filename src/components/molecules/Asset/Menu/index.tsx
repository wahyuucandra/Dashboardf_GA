...
import IconAssetOfficeOperation from '@assets/icons/IconVehicleOfficeOperation'
import IconAssetSpecialOperation from '@assets/icons/IconVehicleSpecialOperation'
    ...
    <div className="relative">
      ...
      <div className="px-3 pt-[200px]">
        <div className="flex items-center space-x-3 mb-4">
          <IconAsset width={32} height={32}></IconAsset>
          <div>
            <div className="text-heading xs semibold-16 text-[#2C598D]">Asset</div>
        ...
        <div className="grid grid-cols-2 gap-4 text-center">
          ...
          >
            <IconAssetSpecialOperation className="mx-auto mb-2"></IconAssetSpecialOperation>
          ...
          <Link
            ...
            className="bg-[#2C598D]/[.08] shadow-[0_1px_4px_1px_rgba(0,0,0,0.1)] p-6 flex flex-col space-y-3 rounded-[20px]"
          >
            <IconAssetOfficeOperation className="mx-auto"></IconAssetOfficeOperation>
