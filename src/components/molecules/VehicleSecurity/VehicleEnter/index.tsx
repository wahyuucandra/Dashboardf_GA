...
import { VehicleSecurityEnterForm } from '@interfaces/vehicle'
...
export function VehicleEnter() {
  ...
  const { handleSubmit, setValue, control } = useForm<VehicleSecurityEnterForm>({
    defaultValues: {},
  })

  const refuel = useWatch({
    control,
    name: 'refuel',
  })
  ...
  return (
    <>
      <Header
        ...
        title="Form Masuk Kendaraan Investaris"
        key={'header'}
      ></Header>
          ...
          <div className="p-1">
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="grid grid-cols-1 gap-2">
                ...
                <div className="mb-6">
                  <div className="text-heading xs regular-16 mb-3">
                    Isi BBM<span className="text-[#E15241]">*</span>
                  </div>
                  <div className="w-2/3 flex items-center space-x-1">
                    <label className="flex-1 flex items-center custom-radio text-paragraph regular-14">
                      ...
                      <input
                        type="radio"
                        onChange={() => setValue('refuel', true)}
                        defaultChecked={refuel}
                        name="radio"
                      />
                    ...
                    <label className="flex-1 flex items-center custom-radio text-paragraph regular-14">
                      ...
                      <input
                        type="radio"
                        onChange={() => setValue('refuel', false)}
                        defaultChecked={refuel === false}
                        name="radio"
                      />
                      <span className="-mt-0.5 radio"></span>
                    </label>
