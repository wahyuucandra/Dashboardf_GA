...
export function Management() {
  ...
  const managementTypes: ManagementType[] = [
    ...
    {
      links: ['guidance'],
      text: 'Cleaning Service Guidance',
    },
  ]
  ...
  return (
    <>
      ...
      <div className="px-4">
        {handleShowForm(['manpower', '']) && (
          <CleaningServiceManpowerForm
            onSubmitForm={() => {
              // action here
            }}
          />
        )}
        {handleShowForm(['rating']) && (
          <CleaningServiceRatingForm
            onSubmitForm={() => {
              // action here
            }}
          />
        ...
        {handleShowForm(['guidance']) && <div></div>}
      </div>
