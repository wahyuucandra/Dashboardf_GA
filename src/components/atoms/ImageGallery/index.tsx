...
// const ImageCard: React.FC<ImageCardProps> = ({ src, isMain, onClose }) => {
// 	return (
...
// 					<div
// 						className='border border-[#d5d5d5] rounded grid place-items-center w-[125px] h-[125px] items-center justify-left cursor-pointer bg-[#f9f8ff]'
// 						onClick={() =>
// 							handleAddImage(
// 								'https://via.placeholder.com/600x400.png?text=Gambar'
// 							)
// 						}
// 						onKeyDown={() => {}}
// 						role='button'
...
// 					</div>
// 					<p className='mt-2 text-center w-[175px]'>
