...
export function CleaningServiceRatingForm({ onSubmitForm }: { onSubmitForm: (formValue: any) => void }) {
      ...
      <div>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-4">
            <Controller
              ...
              render={({ field, formState: { errors } }) => (
                <>
                  <div className="text-heading xs regular-16 text-[#0C0C0C] mb-1">Tanggal Assesment</div>
          ...
          <div className="mb-4">
            ...
            <p className="text-heading xs regular-16 mb-2">Form Penilaian</p>
            <p className="text-extra-small regular-12 text-[#B1B1B1] mb-2">
              Isi Nilai security: 1 Sangat Buruk, 10 Sangat Baik
            </p>
            <div className="dividers mb-2" />
